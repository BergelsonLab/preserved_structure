...
words/images for each of the 27 items were also consistent across these
spaces.
...
data:  wb_prod_long_allmonths$overall_prop_prod and wb_prod_long_allmonths$overlapratio
t = -1.1886, df = 25, p-value = 0.2458
...
data:  wb_comp_long_allmonths$overall_prop_comp and wb_comp_long_allmonths$overlap_count
