...
If we compute neighbor `overlap' across the spaces, we find that the
overlap is significantly greater than 0, i.e.~the images considered
`close' and the words considered `close' overlapped (Mean Overlap XX,
p\textless{} XX by wilcoxon test)
