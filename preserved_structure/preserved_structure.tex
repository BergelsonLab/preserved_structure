...
images). We ignore these practical uses and instead focus on the
representations these algorithms learn, using them as a window into the
structure of visual and semantic forms.
