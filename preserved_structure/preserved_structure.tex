...
\textbf{BRENT \& SISKIND 2001}(Frank, Braginsky, Yurovsky, \& Marchman,
2017)), or by being one of the top 10 concrete nouns heard in each
infants' own home audio and video recordings in the preceding two
months.
...
\textbf{shameless ref to our last year cogsci paper}. Thus, in
word-vector space, each of our 27 items is represented as a
300-dimensional vector, with each word assigned a unique point in a
common vector space. \textbf{confirm that my paraphrase is ok}
...
\textbf{ref frank et al paper }, and that animacy is a robust linguistic
