...
to understand the word (\(R=-0.48\), \(p = 0.011017\)) and produce the
word (\(R=-0.46\), \(p = 0.017069\)); see Figure
\ref{fig:overlap-aoa-graphs}. That is, words with more overlapping
neighbors are later-learned (or put otherwise, known by fewer children)
...
correlate with word knowledge (all \(p > .05\)).
