...
number of image-only and word-only neighbors (see Table
\ref{tbl:overlap-table})); these measures did not correlate with word
knowledge (all \(p > .05\)).
...
\hypertarget{ref-gleitman2005hard}{}
