...
Infants learning language are presented with a challenge to carve the
world into distinct lexical entities, provided with little supervision
in their task of mapping the territory of what William James (1890)
called a ``great blooming, buzzing confusion''.
