...
cor.test(wb_prod_long_allmonths$overall_prop_prod, wb_prod_long_allmonths$overlapratio)
ggplot(wb_prod_long_allmonths, aes(overall_prop_prod, overlap_count,color = factor(definition)))+
  geom_point()+
...
cor.test(wb_comp_long_allmonths$overall_prop_comp, wb_comp_long_allmonths$overlap_count)
ggplot(wb_comp_long_allmonths, aes(overall_prop_comp, overlap_count,color = factor(definition)))+
  geom_point()+
  stat_smooth(method = "lm", aes(group  =1))
