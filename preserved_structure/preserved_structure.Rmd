...
$$
We define $d(x, y)$ as the cosine distance measure:
...
<!-- eb:check if my reword is correct (top 1 = `r round(top_1_perf, 2)`, top 5 = `r round(top_5_perf, 2)`).  -->
Even when incorrect, predictions tended to reflect idiosyncracies in child-relevant items, e.g. the top guess for a cartoon puppy was "teddy". 
<!-- eb: if we're really stuck for space, can drop the above sentence -->
<!-- eb: taking a break, will resume here but committing for now -->
## Comparing spaces 
...
We thank the Bergelson Lab, Eric Bigelow, and NIH DP5-OD019812.
