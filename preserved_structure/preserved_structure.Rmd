...
ggplot(wb_all, aes(overlap_count,prop_kids, color = comp_prod))+
  geom_point(shape=1)+
  geom_text_repel(aes(label = definition), size=2.6, force=4)+
